...
class Test_DataIngestion_unzip_and_clean_data:
    
    artifact_dir = Path('tests/data/')
    source_download_url = ''
    downloaded_data_filepath = Path('tests/data/sample_data.zip')
